    ...
    return (
      <section class="container intro">
        <div className="introText">
          ...
          <h3 class="introHeading3">Software Developer/ Tester</h3>
          <p class="introParagraph">I decided to switch careers in 2021 and followed the route of Front End Web Devlopement. I am currently working as a Quality Assurance Tester 
              for Bluegrass Digital.
          </p>
          <a href="https://github.com/JackNortje" class="github-projects" target="_blank"><button class="githubButton">Github Repos</button></a>
          </div>
      </section>
